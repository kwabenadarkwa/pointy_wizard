...
- [ ] create a custom node for the decision node
...
- [ ] I have to think about what I'm going to be using to delete nodes that are created by the user
...
- [ ] the control pane that holds all the things you could select seems to be behing the canvas, think of how you can bring
      it infront of it
